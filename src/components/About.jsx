    ...
    <section id="about" className="py-24 relative z-10 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mb-16">
          ...
          <div className="lg:col-span-5 glass-card rounded-2xl p-7 flex flex-col justify-between relative overflow-hidden group">
            ...
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-xl bg-cyber-emerald/15 border border-cyber-emerald/30 flex items-center justify-center text-cyber-emerald">
                <GraduationCap className="w-6 h-6" />
              </div>
              <div>
                <span className="text-xs font-mono uppercase tracking-wider text-cyber-emerald">Currently Pursuing</span>
                <h3 className="text-2xl font-display font-bold text-white mt-1">
                  B.Tech in Computer Science & Engineering
                </h3>
                <p className="text-cyber-cyan text-sm font-medium mt-0.5">
              ...
              <div className="space-y-2.5 pt-3 border-t border-white/10 text-sm text-slate-300">
                <div className="flex items-center gap-2">
                  <Award className="w-4 h-4 text-cyber-emerald shrink-0" />
                  <span>Institution: <strong className="text-white">Galgotias University</strong></span>
                </div>
                <div className="flex items-center gap-2">
                  <MapPin className="w-4 h-4 text-cyber-cyan shrink-0" />
                  <span>Location: <span className="text-white">Greater Noida, Uttar Pradesh</span></span>
                </div>
                <div className="flex items-center gap-2">
                  <Calendar className="w-4 h-4 text-cyber-indigo shrink-0" />
                  <span>Academic Period: <span className="text-white">2024 – 2028</span></span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 pt-5 border-t border-white/10 flex items-center justify-between">
              <div>
                <div className="text-xs text-slate-400">Cumulative Grade Point Average</div>
                <div className="text-2xl font-display font-bold text-white">7.95 <span className="text-xs text-slate-400 font-normal">/ 10</span></div>
              </div>
              <div className="px-3 py-1.5 rounded-lg bg-cyber-emerald/15 border border-cyber-emerald/30 text-cyber-emerald text-xs font-semibold">
                NVIDIA Certified
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 glass-card rounded-2xl p-7 flex flex-col justify-center space-y-5">
            ...
            {/* Key Focus Tags */}
            <div className="pt-2">
              <div className="text-xs font-mono uppercase text-slate-400 mb-2.5">Key Core Disciplines:</div>
              <div className="flex flex-wrap gap-2">
                {personalData.academicFocus.map((interest, idx) => (
                  <span
                    key={idx}
                    className="px-3 py-1 rounded-lg text-xs font-medium bg-dark-800 border border-white/10 text-slate-200 hover:border-cyber-emerald/40 transition-colors"
                  >
                    {interest}
                  </span>
                ))}
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-display font-semibold text-white">Areas of Focus</h3>
            <span className="text-xs text-slate-400 font-mono">Curriculum & Self-Initiated Study</span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {technicalFocus.map((item, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="glass-card rounded-xl p-5 space-y-2 border border-white/5 hover:border-cyber-emerald/30 transition-all group"
                >
                  <div className="w-9 h-9 rounded-lg bg-cyber-emerald/10 border border-cyber-emerald/20 flex items-center justify-center text-cyber-emerald group-hover:bg-cyber-emerald/20 transition-colors">
                    <Icon className="w-4 h-4" />
                  </div>
                  <h4 className="font-semibold text-sm text-white group-hover:text-cyber-emerald transition-colors">
                    {item.title}
                  </h4>
