...
export default function Terminal() {
  ...
  return (
    <div className="w-full max-w-xl mx-auto rounded-xl overflow-hidden border border-slate-200/90 dark:border-white/10 bg-white/95 dark:bg-dark-900/90 shadow-xl shadow-slate-200/60 dark:shadow-2xl dark:shadow-blue-500/5 backdrop-blur-xl transition-all duration-300 hover:border-blue-500/40 dark:hover:border-blue-500/30">
      {/* Top Gradient Accent Bar */}
      <div className="h-1 w-full bg-gradient-to-r from-blue-500 via-indigo-500 to-cyan-500 dark:from-blue-500/40 dark:via-indigo-500/40 dark:to-cyan-500/40" />
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-slate-100/90 dark:bg-dark-950/80 border-b border-slate-200 dark:border-white/5 select-none transition-colors">
        <div className="flex items-center gap-2">
          ...
          <span className="ml-2 text-xs font-mono text-slate-700 dark:text-slate-400 flex items-center gap-1.5 transition-colors">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className={`px-2 py-0.5 text-xs font-mono rounded transition-colors ${
              activeTab === 'identity'
                ? 'bg-blue-100/80 text-blue-900 dark:bg-blue-950/60 dark:text-blue-300 font-semibold'
          ...
          <button
            ...
            className={`px-2 py-0.5 text-xs font-mono rounded transition-colors ${
              activeTab === 'academics'
                ? 'bg-indigo-100/80 text-indigo-900 dark:bg-indigo-950/60 dark:text-indigo-300 font-semibold'
                : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200'
            }`}
          >
            edu.env
          ...
          <button
            ...
            className={`px-2 py-0.5 text-xs font-mono rounded transition-colors ${
              activeTab === 'backend'
                ? 'bg-cyan-100/80 text-cyan-900 dark:bg-cyan-950/60 dark:text-cyan-300 font-semibold'
                : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200'
            }`}
          >
            stack.sys
          ...
          <button
            ...
            className="p-1 ml-1 text-slate-500 hover:text-slate-800 dark:hover:text-white rounded hover:bg-slate-200/70 dark:hover:bg-white/5 transition-colors"
          >
